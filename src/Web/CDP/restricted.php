...
if (isset($_SESSION['pseudo']) && isset($_SESSION['password'])){
  $mysql = connect();
  $user = get_user($mysql,$_SESSION['id'])->fetch_array(MYSQLI_ASSOC);
}
?>
    ...
    <div class="wrapper">
      ...
      <div class="inner">
          ...
          <div class="left_nav_slidebar">
            <ul>
              <li> <a href="index.html"><i class="fa fa-home"></i> Acceuil <span class="left_nav_pointer"></span>  </a></li>
                <?php
              if (isset($_SESSION['pseudo']) && isset($_SESSION['password'])) {
                printf("<li> <a href=\"myprofil.php?id=%d\"> <i class=\"fa fa-home\"></i> Mon Profil </a></li>",$user["id"]);
        ...
        <div class="contentpanel">
         ...
         <div class="col-lg-12 ">
           <img src="images/restricted.jpg" class="img-responsive" alt="404" style="margin: 0 auto;"> 
           </div>
         </div>
       </div>
       <!--\\\\\\\ inner end\\\\\\-->
